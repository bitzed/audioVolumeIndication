...
async function join() {
  ...
  console.log("[debug] publish success, and switch audio control active.");
}
async function getStats() {
  if (localTracks.videoTrack){
    var stats = localTracks.videoTrack.getStats();
    for(var i in stats){
...
async function subscribe(user, mediaType) {
  ...
  $("#setVolume0").click(function (e){
    user.audioTrack.setVolume(0);
  });
  $("#setVolume100").click(function (e){
